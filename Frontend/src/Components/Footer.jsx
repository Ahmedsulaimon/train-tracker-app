    ...
    <footer className="bg-gray-800 w-screen fixed bottom-0 h-20">
      <div className="flex justify-between items-center px-8 h-full">
        ...
        <div className="flex justify-center items-center flex-grow">
          <button className="text-white cursor-pointer" style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)' }} onClick={toggleModal}>Journey Legend</button>
        </div>
        ...
        <div id="default-modal" className="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex justify-center items-center">
          <div className="relative bg-white rounded-lg shadow-lg max-w-xl w-full">
            ...
            <div className="p-4 space-y-4 max-h-80 overflow-y-auto">
              ...
              <div className="legend-item mr-4" style={{ display: 'flex', alignItems: 'center' }}>
                <img src="./images/train-icon.png" alt="Train Icon" className="w-10 h-10" />
                <span className="text-gray-800 text-lg ml-2">Train Current Location</span>
              </div>
              <div className="legend-item mr-4" style={{ display: 'flex', alignItems: 'center' }}>
                <img src="./images/black dot.png" alt="Black Dot" className="w-10 h-10" />
                <span className="text-gray-800 text-lg ml-2">Train Destination</span>
              </div>
              <div className="legend-item mr-4" style={{ display: 'flex', alignItems: 'center' }}>
                <img src="./images/black dot 2.png" alt="Black Dot 2" className="w-10 h-10" />
